 ...
 */
var Conditional = function Conditional(args) {
  args = args || {};

  var noop = function noop(conds, data) {};
...
module.exports.and = function (conds, data) {
  var values = Object.keys(conds).map(function (key) {
    return conds[key]();
  });
...
module.exports.springFactory = function (zeta, k, pixels, dynamics) {
	...
	var decayfn = function decayfn(t) {
...
$.fn.scrollTo = function (target, options) {
  ...
  _this.addClass('autoscrolling').on('mousewheel DOMMouseScroll', function (evt) {
    evt.preventDefault();
    evt.stopPropagation();
  });
...
},{"./zepto.js":7}],4:[function(require,module,exports){
"use strict";
...
Login.bindReact = function () {
	var tuples = [['gateway', Gateway], ['registration', Registration], ['header', FixedHeader]];
...
Login.component = function (name, klass, selector) {
	if (klass !== undefined) {
		GLOBAL.components[name] = React.render(React.createElement(klass, null), $(selector)[0]);
	}
...
Login.togglePasswordVisibility = function (evt) {
	...
	if (password.attr('type') === 'password') {
		...
		toggle.text(_('hide')).addClass('visible');
	} else {
		password.attr('type', 'password');
		toggle.text(_('show')).removeClass('visible');
	}
	...
	$.post("/1.0/internal/account/authenticate/facebook/", postdata, function (response) {
		...
		if (response.success) {
			...
			if (response.error.length) {
				$('#loginsocialerror').text(loginFacebookAccountFixtext(response.error[0])).slideFadeIn();
			}
		}
	});
};
	...
	$.post("/1.0/internal/account/register/facebook/", postdata, function (response) {
		...
		if (response.success) {
			...
			if (response.reasons.username) {
				...
				$('#registersocialerror').text(registrationAccessTokenFixtext(response.reasons.access_token)).slideFadeIn();
			} else if (response.reasons.facebook_account) {
				$('#registersocialerror').text(registrationFacebookAccountFixtext(response.reasons.facebook_account)).slideFadeIn();
			}
		}
	});
};
...
Login.configureLoginPage = function () {
	...
	$('#username').attr('maxlength', 40).thinking({ idle: 1000 }, function () {
		loginValidateUsernameNoLength(this, logincoordinator);
	}).on('focus', Utils.UI.trim()).on('blur', Utils.UI.trim(function () {
		loginValidateUsernameNoLength(this, logincoordinator);
	})).on('keyup', function () {
...
function createLoginCoordinator() {
	return new Conditional.Conditional({
		...
		failure: function failure(conds, data) {
			var stack = [{
				elem: $('#username'),
				...
				condition: 'password',
				onalert: function onalert(msgelem) {
					$(msgelem).fadeIn(300);
				},
				onresolved: function onresolved(msgelem) {
					$(msgelem).fadeOut(300);
				}
			}];
		...
		success: function success(conds) {
...
function configureForgotPassword() {
	...
	var forgotcoordinator = new Conditional.Conditional({
		set: { sent: false },
		success: function success(conds, data) {
			$('#loginpassworderror').text(loginForgotPasswordFixtext('success')).slideFadeIn();
		},
		failure: function failure(conds, data) {
			$('#loginpassworderror').text(loginForgotPasswordFixtext(data.sent)).slideFadeIn();
	...
	if (wasreset) {
		$('#pitch').text(_('Your password was reset.')).show();
	}
}
...
Login.configureRegistrationPage = function () {
	$('#togglemode').attr('href', '/login').text(_('LOGIN'));

	$('#signintype').first().text(_('SIGN UP'));

	$('#pitch').show();

	$('#username').addClass('bottom-rounded').attr('placeholder', _('Username')).focus();

	$('.register.step1').show();

	var playcoordinator = new Conditional.Conditional({
		set: { username: true, password: true, email: true },
		test: function test(conds) {
		...
		failure: function failure(conds, data) {
			...
			$('#usernameerror').text(registrationUsernameFixtext(data.username)).slideFadeIn();
		}
	});
	...
	var playnowclickhandler = function playnowclickhandler() {
	...
	$('.playnow').text(_('SIGN UP')).on('click.Register', playnowclickhandler);
...
Login.bindRegistrationAvailabilityHandlers = function (playcoordinator) {
	$('#username').thinking({ idle: 750 }, function () {
	...
	$('#registrationpassword').on('focus', function () {
	...
	$('#email').thinking({ idle: 2000 }, function () {
...
Login.playNowContinueHandler = function (playcoordinator) {
	...
	$('#username').thinking('done').off('blur');

	$('.playnow').text(_("PLAY NOW")).addClass('fullwidth').ion('click.Register', register);
...
function coordinationFailure(stack, conds, data) {
	...
	for (var i = 0; i < stack.length; i++) {
		...
		if (!conds[field.condition]) {
			...
			if (first) {
				msgelem.text(field.fixtextfn(data[field.condition]));
...
},{"../components/gateway.jsx":8,"../components/header.jsx":9,"../components/registration.jsx":10,"./easing.js":2,"./utils.js":6,"./zepto.js":7,"react":184}],5:[function(require,module,exports){
'use strict';
...
},{"./jquery-animation.js":3,"./login.js":4,"./zepto.js":7}],6:[function(require,module,exports){
"use strict";
...
Utils.numberToCondensedSI = function (args) {
  ...
  if (precision > 0) {
    precisenum = precisenum.substr(0, precisenum.length - precision) + "." + precisenum.substr(precisenum.length - 1, precision);
  }
...
Utils.nvl = function (val, ifnull) {
  return !(val === undefined || val === null) ? val : ifnull;
};
...
Utils.plural = function (ct, phrase) {
  ...
  while (match = multicapture.exec(phrase)) {
    ...
    var replacement = isplural ? pluralversion : singular;
...
},{"./zepto.js":7}],7:[function(require,module,exports){
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'button',
					{ onClick: this.gotoRegistration, className: 'primary' },
					'Start Playing'
				)
			),
			React.createElement(
				'button',
				{ onClick: this.gotoExplore, className: 'explorebtn secondary' },
				'Explore'
			)
		);
	}
...
},{"../clientjs/easing.js":2,"react":184}],9:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
	...
	renderGateway: function renderGateway() {
		...
		return React.createElement(
			...
			React.createElement('div', { onClick: '', className: 'icon share' })
		);
	},
	render: function render() {
...
module.exports = React.createClass({
	...
	stage_one_render: function stage_one_render() {
		return React.createElement(
			'div',
			{ className: 'registration column' },
			React.createElement('img', { className: 'logo', src: '/images/ew.svg', alt: 'EyeWire Logo' }),
			React.createElement(
				'div',
				{ className: 'location-text' },
				'Select Username'
			),
			React.createElement('div', { className: 'progress-indicator one' }),
			React.createElement(
				'div',
				{ className: 'column' },
				React.createElement('input', { className: 'username', placeholder: 'Username', type: 'text', valueLink: this.linkState('username') }),
				React.createElement(
					'button',
					{ onClick: this.activateStageTwo, className: 'primary' },
					'OK'
				)
			)
		);
	},
	stage_two_render: function stage_two_render() {
		return React.createElement(
			'div',
			{ className: 'registration column' },
			React.createElement('img', { className: 'logo', src: '/images/ew.svg', alt: 'EyeWire Logo' }),
			...
			React.createElement('div', { className: 'progress-indicator two' }),
			React.createElement(
				'div',
				{ className: 'column' },
				React.createElement('input', { className: 'username', placeholder: 'Username', type: 'text', valueLink: this.linkState('username') }),
				React.createElement('input', { className: 'email', placeholder: 'Email', type: 'text', valueLink: this.linkState('email') }),
				React.createElement('input', { className: 'password', placeholder: 'Password', type: 'password', valueLink: this.linkState('password') }),
				React.createElement(
					'button',
					{ onClick: this.register, className: 'primary' },
					'PLAY'
				)
			),
			React.createElement(
				'div',
				{ className: 'fb-connect tertiary' },
				'Facebook Connect'
			)
		);
	},
...
},{"../clientjs/conditional.js":1,"react/addons":12}],11:[function(require,module,exports){
...
},{"./invariant":162,"_process":11}],16:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSProperty":16,"./ExecutionEnvironment":33,"./camelizeStyleName":133,"./dangerousStyleValue":140,"./hyphenateStyleName":160,"./memoizeStringOnly":171,"./warning":183,"_process":11}],18:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":40,"./PooledClass":41,"./invariant":162,"_process":11}],19:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":24,"./ReactMultiChildUpdateTypes":90,"./invariant":162,"./setTextContent":177,"_process":11}],22:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":162,"_process":11}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":22,"./quoteAttributeValueForBrowser":175,"./warning":183,"_process":11}],24:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":33,"./createNodesFromMarkup":138,"./emptyFunction":141,"./getMarkupWrap":154,"./invariant":162,"_process":11}],25:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":141,"_process":11}],29:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":30,"./EventPluginUtils":31,"./accumulateInto":130,"./forEachAccumulated":147,"./invariant":162,"_process":11}],30:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":162,"_process":11}],31:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":27,"./invariant":162,"_process":11}],32:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":27,"./EventPluginHub":29,"./accumulateInto":130,"./forEachAccumulated":147,"_process":11}],33:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypes":97,"./invariant":162,"_process":11}],38:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactBrowserEventEmitter":44,"./accumulateInto":130,"./forEachAccumulated":147,"./invariant":162,"_process":11}],39:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":162,"_process":11}],42:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginUtils":31,"./ExecutionEnvironment":33,"./Object.assign":40,"./ReactChildren":48,"./ReactClass":49,"./ReactComponent":50,"./ReactContext":55,"./ReactCurrentOwner":56,"./ReactDOM":57,"./ReactDOMTextComponent":68,"./ReactDefaultInjection":71,"./ReactElement":74,"./ReactElementValidator":75,"./ReactInstanceHandles":83,"./ReactMount":88,"./ReactPerf":93,"./ReactPropTypes":97,"./ReactReconciler":100,"./ReactServerRendering":103,"./findDOMNode":144,"./onlyChild":172,"_process":11}],43:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSCore":15,"./React":42,"./ReactTransitionEvents":108,"./onlyChild":172,"./warning":183,"_process":11}],47:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./PooledClass":41,"./ReactFragment":80,"./traverseAllChildren":181,"./warning":183,"_process":11}],49:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactUpdateQueue":110,"./invariant":162,"./warning":183,"_process":11}],51:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":162,"_process":11}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":40,"./emptyObject":142,"./warning":183,"_process":11}],56:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":74,"./ReactElementValidator":75,"./mapObject":170,"_process":11}],58:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":17,"./DOMChildrenOperations":21,"./DOMPropertyOperations":23,"./ReactMount":88,"./ReactPerf":93,"./invariant":162,"./setInnerHTML":176,"_process":11}],62:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":13,"./DOMPropertyOperations":23,"./LinkedValueUtils":37,"./Object.assign":40,"./ReactBrowserComponentMixin":43,"./ReactClass":49,"./ReactElement":74,"./ReactMount":88,"./ReactUpdates":111,"./invariant":162,"_process":11}],65:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactBrowserComponentMixin":43,"./ReactClass":49,"./ReactElement":74,"./warning":183,"_process":11}],66:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":13,"./DOMPropertyOperations":23,"./LinkedValueUtils":37,"./Object.assign":40,"./ReactBrowserComponentMixin":43,"./ReactClass":49,"./ReactElement":74,"./ReactUpdates":111,"./invariant":162,"./warning":183,"_process":11}],70:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":40,"./ReactContext":55,"./ReactCurrentOwner":56,"./warning":183,"_process":11}],75:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":56,"./ReactElement":74,"./ReactFragment":80,"./ReactNativeComponent":91,"./ReactPropTypeLocationNames":95,"./ReactPropTypeLocations":96,"./getIteratorFn":153,"./invariant":162,"./warning":183,"_process":11}],76:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":74,"./ReactInstanceMap":84,"./invariant":162,"_process":11}],77:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":74,"./warning":183,"_process":11}],81:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":102,"./invariant":162,"_process":11}],84:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":40,"./invariant":162,"_process":11}],92:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":162,"_process":11}],93:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElementValidator":75,"./ReactRef":101,"_process":11}],101:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":74,"./ReactInstanceHandles":83,"./ReactMarkupChecksum":87,"./ReactServerRenderingTransaction":104,"./emptyObject":142,"./instantiateReactComponent":161,"./invariant":162,"_process":11}],104:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":40,"./ReactCurrentOwner":56,"./ReactElement":74,"./ReactInstanceMap":84,"./ReactLifeCycle":85,"./ReactUpdates":111,"./invariant":162,"./warning":183,"_process":11}],111:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":18,"./Object.assign":40,"./PooledClass":41,"./ReactCurrentOwner":56,"./ReactPerf":93,"./ReactReconciler":100,"./Transaction":128,"./invariant":162,"./warning":183,"_process":11}],112:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./LinkedStateMixin":36,"./React":42,"./ReactCSSTransitionGroup":45,"./ReactComponentWithPureRenderMixin":53,"./ReactDefaultPerf":72,"./ReactFragment":80,"./ReactTestUtils":106,"./ReactTransitionGroup":109,"./ReactUpdates":111,"./cloneWithProps":134,"./cx":139,"./update":182,"_process":11}],113:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":162,"_process":11}],129:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":162,"_process":11}],131:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":74,"./ReactPropTransferer":94,"./keyOf":169,"./warning":183,"_process":11}],135:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactClass":49,"./ReactElement":74,"./invariant":162,"_process":11}],138:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":33,"./createArrayFromMixed":136,"./getMarkupWrap":154,"./invariant":162,"_process":11}],139:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./warning":183,"_process":11}],140:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":56,"./ReactInstanceMap":84,"./ReactMount":88,"./invariant":162,"./isNode":164,"./warning":183,"_process":11}],145:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":181,"./warning":183,"_process":11}],146:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":33,"./invariant":162,"_process":11}],155:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":40,"./ReactCompositeComponent":54,"./ReactEmptyComponent":76,"./ReactNativeComponent":91,"./invariant":162,"./warning":183,"_process":11}],162:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":162,"_process":11}],169:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":74,"./invariant":162,"_process":11}],173:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./warning":183,"_process":11}],180:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":162,"_process":11}],181:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":74,"./ReactFragment":80,"./ReactInstanceHandles":83,"./getIteratorFn":153,"./invariant":162,"./warning":183,"_process":11}],182:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":40,"./invariant":162,"./keyOf":169,"_process":11}],183:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":141,"_process":11}],184:[function(require,module,exports){
