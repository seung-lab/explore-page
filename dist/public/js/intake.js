...
module.exports = function (args) {
	...
	this.t = 0, this.name = 'Amazing', this.begin = null, this.duration = utils.nvl(args.duration, 1), this.parent = args.parent, this.selector = $(args.selector)[0];
...
},{"../../components/modules/amazing.jsx":12,"../utils.js":8,"../zepto.js":9,"react/addons":17}],3:[function(require,module,exports){
'use strict';
...
TimelineController.initialize = function () {
	TimelineController.setModules([new AmazingModule({
...
TimelineController.render = function () {
	var mod = TimelineController.currentModule();
	var t_mod = (_t - mod.begin) / mod.duration;

	var Module = mod.view();

	React.render(React.createElement(
		'div',
		{ className: 'fullscreen column' },
		React.createElement(Module, { t: t_mod }),
		React.createElement(Timeline, { t: _t })
...
},{"../../components/timeline.jsx":14,"../utils.js":8,"./amazing.jsx":2,"react/addons":17}],4:[function(require,module,exports){
"use strict";
...
},{"./zepto.js":9}],6:[function(require,module,exports){
"use strict";
...
},{"../components/gateway.jsx":10,"../components/header.jsx":11,"../components/registration.jsx":13,"./controllers/timelinecontroller.jsx":3,"./easing.js":4,"./utils.js":8,"./zepto.js":9,"react/addons":17}],7:[function(require,module,exports){
'use strict';
...
},{"./jquery-animation.js":5,"./login.js":6,"./zepto.js":9}],8:[function(require,module,exports){
"use strict";
...
},{"./zepto.js":9}],9:[function(require,module,exports){
...
},{"../clientjs/easing.js":4,"react/addons":17}],11:[function(require,module,exports){
'use strict';
...
},{"classnames":16,"react/addons":17}],12:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
	...
	currentSlide: function currentSlide() {
		var N = this.state.slides.length;

		var index = Math.floor(this.state.t * N);
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			{ className: 'amazing bg-light' },
			React.createElement(
				'video',
				{ controls: true },
				React.createElement('source', { src: '/animations/out.mp4' })
			),
			React.createElement(
				'div',
...
},{"../../clientjs/utils.js":8,"react/addons":17}],13:[function(require,module,exports){
'use strict';
...
},{"../clientjs/conditional.js":1,"react/addons":17}],14:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
	...
	componentWillMount: function componentWillMount() {},
	render: function render() {
		var t = utils.clamp(this.props.t, 0, 1);
		...
		return React.createElement(
			'div',
			{ className: 'timeline' },
			React.createElement('div', { style: styles, className: 'progress' })
		);
	}
});

},{"../clientjs/utils.js":8,"react/addons":17}],15:[function(require,module,exports){
...
},{"./emptyFunction":146,"_process":15}]},{},[7]);
